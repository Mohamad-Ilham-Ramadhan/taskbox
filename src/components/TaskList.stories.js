...
const updateTaskState = (state, action) => {
...
Loading.decorators = [story => <MockStore taskboxState={{ ...MockedState, status: 'loading' }}>{story()}</MockStore>];

export const Empty = Template.bind({});
Empty.decorators = [story => <MockStore taskboxState={{ ...MockedState, tasks: [] }}>{story()}</MockStore>]